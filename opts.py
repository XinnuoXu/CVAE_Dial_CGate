...
def model_opts(parser):
    ...
    # Latent variable
    group.add_argument('-src_word_vec_size_vae', type=int, default=64,
                       help='Word embedding size for src of latent variable LSTM')
    group.add_argument('-dropout_vae', type=float, default=0.2,
                       help="Dropout probability; applied in LSTM stacks.")
    group.add_argument('-rnn_size_vae', type=int, default=64,
                       help='Size of rnn hidden states of latent variable LSTM')
    group.add_argument('-size_vae', type=int, default=20,
...
def preprocess_opts(parser):
    ...
    group.add_argument('-src_vocab_size', type=int, default=35000,
                       help="Size of the source vocabulary")
    group.add_argument('-tgt_vocab_size', type=int, default=25000,
